import type { TextMapPropagator, ContextManager, TextMapGetter, Attributes } from "@opentelemetry/api";
import type { Instrumentation } from "@opentelemetry/instrumentation";
import type { ResourceDetector } from "@opentelemetry/resources";
import type { LogRecordProcessor } from "@opentelemetry/sdk-logs";
import type { IdGenerator, Sampler, SpanExporter, SpanLimits, SpanProcessor } from "@opentelemetry/sdk-trace-base";
import type { MetricReader, ViewOptions } from "@opentelemetry/sdk-metrics";
import type { FetchInstrumentationConfig } from "./instrumentations/fetch";
export type PropagatorOrName = TextMapPropagator | "auto" | "none" | "tracecontext" | "baggage";
export type SampleOrName = Sampler | "auto" | "always_off" | "always_on" | "parentbased_always_off" | "parentbased_always_on" | "parentbased_traceidratio" | "traceidratio";
...
export type AttributesFromHeaderFunc = <Carrier = unknown>(headers: Carrier, getter: TextMapGetter<Carrier>) => Attributes | undefined;
export type AttributesFromHeaders = Record<string, string> | AttributesFromHeaderFunc;
